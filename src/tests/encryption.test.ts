...
import { encrypt, decrypt, encryptXTokens, decryptXTokens } from "../services/encryption";
...
describe("Encryption Service", () => {
  ...
  describe("X Token Encryption", () => {
    ...
    it("should decrypt X tokens object", () => {
      ...
      const encrypted = encryptXTokens(accessToken, refreshToken);
      const decrypted = decryptXTokens(encrypted.xAccessToken, encrypted.xRefreshToken);
