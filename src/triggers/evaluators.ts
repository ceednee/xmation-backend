...
export const highEngagementEvaluator: TriggerEvaluator = (config, context) => {
	...
	const timeWindow = Number(config.timeWindow) || 3600000; // 1 hour default
...
export const unfollowDetectedEvaluator: TriggerEvaluator = (
	config,
	context,
) => {
