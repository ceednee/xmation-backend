...
const getMasterKey = (): Buffer => {
  ...
  const salt = process.env.ENCRYPTION_SALT || "default_salt_change_in_production";
 ...
 */
export function decryptXTokens(encryptedAccessToken: string, encryptedRefreshToken: string) {
  return {
